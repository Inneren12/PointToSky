...
class DataLayerE2ETest {
    ...
    @Test
    fun searchCardSetTargetSendsAimMessage() =
        runBlocking {
            ...
            val ack =
                MobileBridge.get(context).send(PATH_AIM_SET_TARGET) { cid ->
    ...
    @Test
    fun identifyResultUpdatesCardRepositoryAndLaunchesCard() =
        runBlocking {
            val payload =
                JSONObject().apply {
            ...
            val fakeSender =
                object : DlMessageSender.Delegate {
