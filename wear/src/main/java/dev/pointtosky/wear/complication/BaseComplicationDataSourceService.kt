...
abstract class BaseComplicationDataSourceService : SuspendingComplicationDataSourceService() {
    ...
    protected fun icon(@DrawableRes id: Int): Icon = Icon.createWithResource(this, id)

    protected fun monochromaticImage(@DrawableRes id: Int): MonochromaticImage =
        MonochromaticImage.Builder(icon(id)).build()
    ...
    protected fun text(@StringRes id: Int, vararg args: Any): ComplicationText =
        PlainComplicationText.Builder(getString(id, *args)).build()

    protected fun text(value: CharSequence): ComplicationText =
        PlainComplicationText.Builder(value).build()

    protected fun contentDescription(@StringRes id: Int, vararg args: Any): ComplicationText =
        text(id, *args)
    ...
    protected fun readPrefs(@Suppress("UNUSED_PARAMETER") request: ComplicationRequest): ComplicationPrefs =
        ComplicationPrefs()
